...
window.GradebookStore = (function() {
    ...
    function generateSavePayload() {
        ...
        // 🌟 完美銜接 utils-date，取得台灣時區 ISO Timestamp
        ...
        return {
            ...
            // 🌟 防護機制：無論您的表用 assignment_id 還是 task_id 都能安全寫入
            assignment_id: state.activeSubmission.assignment_id || state.activeSubmission.task_id,
